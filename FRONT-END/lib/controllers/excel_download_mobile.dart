...
/// ImplementaciÃ³n de descarga para mÃ³vil/desktop
Future<String?> downloadFile(Uint8List bytes, String filename) async {
  ...
  if (Platform.isAndroid) {
    // En Android, intentar usar el directorio de descargas pÃºblico
    directory = Directory('/storage/emulated/0/Download');
    if (!await directory.exists()) {
      // Si no existe, usar el directorio de la aplicaciÃ³n
