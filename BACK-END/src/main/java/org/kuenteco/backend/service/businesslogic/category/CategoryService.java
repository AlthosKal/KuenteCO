...
public interface CategoryService {
     ...
     * @param idAsset ID del activo (opcional)
     * @param name Nombre de la categoría
     * @param description Descripción de la categoría
     * @param assignedBudget Presupuesto asignado
     * @param startDate Fecha de inicio
     * @param finishDate Fecha de finalización
     * @return La categoría creada
     */
    Category createCategory(Integer idAccount, Integer idAsset, String name,
     ...
     * @param assignedBudget Presupuesto asignado actualizado
     * @param startDate Fecha de inicio actualizada
     * @param finishDate Fecha de finalización actualizada
     * @param state Estado actualizado
     * @return La categoría actualizada
     */
    Category updateCategory(Integer idCategory, String name, DescriptionCategory description,
