...
public class MercadoPagoWebhookValidationService {
     ...
     */
    public boolean isValidWebhookSignature(Map<String, String> headers, String dataId, String requestBody) {
        ...
        try {
            ...
            if (xSignature == null || xRequestId == null) {
                log.warn("Headers requeridos faltantes: x-signature={}, x-request-id={}", xSignature, xRequestId);
                return false;
            }
            ...
            if (!isValid) {
                log.warn("Firma de webhook inválida. Esperada: {}, Recibida: {}", expectedSignature, v1);
